...
const FAQ = () => {
    const faqData = [
        ...
        },
        {
            ...
            answer: 'Да, изучение Анфельции ведется \n' +
                'уже многие годы. Научные работы подтверждают ее биоактивные свойства, в том числе способность очищать организм, укреплять иммунитет \n' +
